...
const ChildProfileSelector = () => {
    const { backendUrl, getUserData, setActiveChild, userData } = useContext(appContext);
        ...
        try {
            ...
            if (data.success) {
                ...
                const childInfo = {
                    ...
                    childName: children.find(c => c._id === childId)?.name || 'Bambino'
                };

                // Salva nel context (per la sessione attuale)
                setActiveChild(childInfo);
                console.log('✅ activeChild salvato:', childInfo);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
            <Helmet>
                <title>Seleziona Profilo Bambino — Storie Amiche</title>
            </Helmet>
            <Navbar />
