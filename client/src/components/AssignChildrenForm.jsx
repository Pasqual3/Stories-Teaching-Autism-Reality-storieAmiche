...
const AssignChildrenForm = ({ children, storyId, gameType, backendUrl, onSuccess }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const endpoint = isEmoGame
                ? `${backendUrl}/api/emoGame/assign-to-children`
            ...
            toast.error(error.response?.data?.message || (isEmoGame ? "Errore assegnazione EmoGame" : "Errore assegnazione storia"));
        } finally {
