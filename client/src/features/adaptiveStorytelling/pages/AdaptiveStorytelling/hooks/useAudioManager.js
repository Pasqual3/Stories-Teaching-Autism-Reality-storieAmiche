...
export const useAudioManager = () => {
    ...
    // Progresso REALE — aggiornato dal server via polling
    const [sceneDone, setSceneDone] = useState(0);
    const [sceneTotal, setSceneTotal] = useState(0);

    // Percentuale di generazione calcolata dalle scene completate
    ...
    /**
     * Callback chiamata dal polling (appContext) ad ogni aggiornamento di stato.
     * Aggiorna il progresso reale delle scene.
     */
    ...
    /**
     * Chiamata prima di avviare la generazione — resetta i contatori
     */
    ...
    /**
     * Chiamata al termine della generazione — imposta il completamento
     */
    ...
    // Manteniamo startFakeProgress come no-op per compatibilità con useStoryPublisher
    const startFakeProgress = useCallback(() => {
        // Non fa nulla — il progresso è ora reale
    }, []);
    ...
    const handleGenerateAudio = useCallback((storyText, storyTitle, onStartGeneration) => {
        ...
        // Avvia la generazione — resetta il progresso con il numero di scene valide
